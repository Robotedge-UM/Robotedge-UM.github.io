...
CREATE TABLE "public"."LandingPageSettings" (
    ...
    "linkedinUrl" TEXT,
    "instagramUrl" TEXT,
    "metaTitle" TEXT NOT NULL DEFAULT 'Robotedge - AI Robotics Lab | University of Malaya',
    "metaDescription" TEXT NOT NULL DEFAULT 'Robotedge AI Robotics Lab at University of Malaya. RoboCup champions in service robotics & humanoid soccer. Led by Dr. Zati Hakim Azizul Hasan.',
    "isActive" BOOLEAN NOT NULL DEFAULT true,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
